...
const String termsOfServicesScreenRoute = '/terms-of-service';
...
const String setUsernameScreenRoute = '/set-username';
const String adminScreenRoute = '/admin';
const String superAdminScreenRoute = '/super-admin';